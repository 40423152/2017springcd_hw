Title: 協同產品設計實習 第十六周作業 40423152
Date: 2017-06-01 12:56
Category:作業
Tags: 作業
Author: 40423152
...
<a href="http://imgur.com/WMXzJ3y"><img src="http://i.imgur.com/WMXzJ3y.png" title="source: imgur.com" /></a>
對於此已經十分"習慣"Solidworks的我來說十分便利，而且也較solvespace人性化，又有像是github一樣的commit紀錄，隨時追蹤設計狀況。

一開始對於線上的soliworks(就是onshape)覺得應該是閹割過的版本吧，不過做得盡善盡美，輸出DXF也是沒有問題的。

重點是他居然可以線上協作，這是令我最喜歡也最驚豔的功能。
...
# put it back
ctx.translate(-x_g6, -y_g6)
Spur(ctx).Gear(x_g6, y_g6, rp_g6, n_g6, pa, "#0066FF")
ctx.restore()
